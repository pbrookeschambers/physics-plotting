...
***:blue[Note:]** The first time you add data, it may take a while (up to 10 to 20 seconds) to process and generate the plot. Subsequent changes should be faster, but may still take a few seconds with large data sets.*